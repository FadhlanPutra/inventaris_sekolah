...
return [
     ...
     */
    // 'cache_profile' => Spatie\ResponseCache\CacheProfiles\CacheAllSuccessfulGetRequests::class,  -- lama --
    'cache_profile' => App\CacheProfiles\FilamentCacheProfile::class,
     ...
     */
    'cache_lifetime_in_seconds' => (int) env('RESPONSE_CACHE_LIFETIME', 60 * 60 * 24 * 30), // 30 Days
